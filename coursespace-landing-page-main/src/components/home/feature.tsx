...
const BorderLinearProgress = styled(LinearProgress, {
  ...
  [`& .${linearProgressClasses.bar}`]: {
    borderRadius: 5,
    ...(order === 1 && { backgroundColor: '#f303ff' }),
    ...(order === 2 && { backgroundColor: '#26e8bd' }),
    ...(order === 3 && { backgroundColor: '#0063ff' }),
  },
}))
        ...
        <Grid container spacing={3}>
          <Grid item xs={12} md={5}>
            <Box sx={{ position: 'relative' }}>
              ...
              >
                ...
                >
                  <Typography sx={{ fontWeight: 600, lineHeight: 1 }}>Real progress</Typography>
          ...
          <Grid item xs={12} md={7}>
            ...
            <Typography sx={{ color: 'text.secondary', mb: 2, ml: { xs: 0, md: 4 } }}>
              Set your learning path the way you like it. With a quick placement test, a clear plan, and engaging,
              practical lessons, you’ll enjoy learning and feel steady progress in real-life English.
            </Typography>
